...
- Clean up data from repo

## [5.2.0] - 2024-05-03

### Added

- PostgreSQL database support for SSPCloud

## [5.1.3] - 2024-05-01

### Added

- GitHub actions: Docker: Run pytest on PR/merge
- GitHub actions: Docker: Build-push images to DockerHub on merge
...
- Retrieving password functionnality

## [5.0.0] - 2024-04-17

### Added

- Notifications class, model, routes, tests and frontend
